...
See latest test runs: https://pulpito.ceph.com/teuthology-2025-04-05_20:56:02-crimson-rados-main-distro-crimson-smithi/
...
From (Seastar's documatnion)[https://docs.seastar.io/master/split/5.html]:
...
For an example of a rewritten code section, see this (commit)[https://github.com/ceph/ceph/pull/61536/commits/878f3bff706bf3e4acd0d4176310dd3fc5230a83]
...
the two macros above were replaced with a *single* `WITH_CRIMSON` macro that supports all the nuances mentioned.

For more details, see the (pull request)[https://github.com/ceph/ceph/pull/61672]

### Updated Seastar Submodule:
Crimson archtirecure is based on the Seastar framework. Our usage of the framework requires some Crimson-specific modifications -
for this reason we use our fork of Seastar (located at ceph/seastar). To to keep up with recent fixes and updates to the upstream framework
our submodule is updated regualry.

See: https://github.com/ceph/seastar/commits/wip-matanb-seastar-feb-25/
...
### // todo Seastore
Seastore:   Omap Iterate
OP_CLONERANGE2 op supprt
...
